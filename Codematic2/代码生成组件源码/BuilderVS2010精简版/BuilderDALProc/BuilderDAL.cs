...
namespace Maticsoft.BuilderDALProc
{
    ...
    public class BuilderDAL : Maticsoft.IBuilder.IBuilderDAL
    {
        ...
        public Hashtable Languagelist
        {
            get
            {
                return Maticsoft.CodeHelper.Language.LoadFromCfg("BuilderDALProc.lan");
            }
        }
        #endregion
        ...
        public string CreatAdd()
        {
            ...
            foreach (ColumnInfo field in Fieldlist)
            {
                ...
                {
                    strclass2.AppendSpaceLine(3, "parameters[" + n + "].Value = Guid.NewGuid();");
                }
                else
                {
        ...
        public string CreatUpdate()
        {
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "int rowsAffected=0;");
            strclass.AppendSpaceLine(3, "" + DbParaHead + "Parameter[] parameters = {");
            int n = 0;
